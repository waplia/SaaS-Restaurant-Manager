...
const navConfig: NavEntry[] = [
  ...
  // 11. Marketplace
  {
    ...
    children: [
      ...
      { kind: "link", href: "/settings/bill-templates", label: "Bill Templates", icon: Receipt, roles: ["owner", "manager"] },
      { kind: "link", href: "/settings/counters", label: "POS Counters (Desktop)", icon: Monitor, roles: ["owner", "manager"] },
