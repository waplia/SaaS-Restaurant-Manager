...
const navConfig: NavEntry[] = [
  ...
  { kind: "link", href: "/surveys", label: "Surveys", icon: MessageSquare, roles: ["owner", "manager"] },
  ...
  },
  {
    ...
    children: [
      ...
      { kind: "link", href: "/ai/feedback-wall", label: "Feedback Wall", icon: Sparkles, roles: ["owner", "manager"] },
