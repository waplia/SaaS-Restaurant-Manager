...
// NOTE: this list is intentionally permissive — anyone with a role bound to a
// tenant is allowed to READ subscription/plan info from their restaurant's
// pages. Several legacy role strings ("chef", "inventory_manager", "hr",
