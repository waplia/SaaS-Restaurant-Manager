...
router.post("/restaurants/:restaurantId/shifts", async (req, res) => {
...
router.patch("/restaurants/:restaurantId/shifts/:id", async (req, res) => {
...
router.delete("/restaurants/:restaurantId/shifts/:id", async (req, res) => {
...
router.post("/restaurants/:restaurantId/staff-shifts", async (req, res) => {
