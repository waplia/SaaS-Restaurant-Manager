...
export async function seedDefaultTemplates(): Promise<void> {
  ...
  const defaults = [
    ...
    { name: "Trial Ending", slug: "trial-ending", channel: "email" as const,
      subject: "Your KhanaLagao trial ends in 3 days",
    ...
    { name: "Subscription Expired", slug: "subscription-expired", channel: "email" as const,
      ...
      body: "Hi {{userName}},\n\nYour KhanaLagao subscription has expired and access is now limited. Renew now to restore full access." },
    { name: "Festival Offer", slug: "festival-offer", channel: "in_app" as const,
      subject: "Special festival offer just for you",
      body: "Celebrate the season with an exclusive offer on KhanaLagao — see the offer details inside the app." },
