...
const api = {
  ...
  inv: {
    list: (req?: IpcContract["inv:list"]["req"]) => invoke("inv:list", req ?? {}),
    adjust: (req: IpcContract["inv:adjust"]["req"]) => invoke("inv:adjust", req),
    transactions: (req: IpcContract["inv:transactions"]["req"]) => invoke("inv:transactions", req),
    wasteLog: () => invoke("inv:waste-log"),
    suppliers: () => invoke("inv:suppliers"),
    supplierCreate: (req: IpcContract["inv:supplier-create"]["req"]) => invoke("inv:supplier-create", req),
    purchaseOrders: (req?: IpcContract["inv:purchase-orders"]["req"]) => invoke("inv:purchase-orders", req ?? {}),
    purchaseOrderCreate: (req: IpcContract["inv:purchase-order-create"]["req"]) => invoke("inv:purchase-order-create", req),
    purchaseOrderReceive: (req: IpcContract["inv:purchase-order-receive"]["req"]) => invoke("inv:purchase-order-receive", req),
    menuItemsStock: () => invoke("inv:menu-items-stock"),
  },
  acc: {
    expenses: (req?: IpcContract["acc:expenses"]["req"]) => invoke("acc:expenses", req ?? {}),
    expenseCreate: (req: IpcContract["acc:expense-create"]["req"]) => invoke("acc:expense-create", req),
    expenseCategories: () => invoke("acc:expense-categories"),
    expenseCategoryCreate: (req: IpcContract["acc:expense-category-create"]["req"]) => invoke("acc:expense-category-create", req),
    paymentsList: (req?: IpcContract["acc:payments-list"]["req"]) => invoke("acc:payments-list", req ?? {}),
    paymentsSummary: (req?: IpcContract["acc:payments-summary"]["req"]) => invoke("acc:payments-summary", req ?? {}),
    pnl: (req?: IpcContract["acc:pnl"]["req"]) => invoke("acc:pnl", req ?? {}),
    targets: () => invoke("acc:targets"),
  },
  mkt: {
    campaigns: (req?: IpcContract["mkt:campaigns"]["req"]) => invoke("mkt:campaigns", req ?? {}),
    analytics: () => invoke("mkt:campaign-analytics"),
    logs: (req?: IpcContract["mkt:campaign-logs"]["req"]) => invoke("mkt:campaign-logs", req ?? {}),
    draft: (req?: IpcContract["mkt:campaign-draft"]["req"]) => invoke("mkt:campaign-draft", req ?? {}),
    templates: (req: IpcContract["mkt:templates"]["req"]) => invoke("mkt:templates", req),
    reviewsFeedback: (req?: IpcContract["mkt:reviews-feedback"]["req"]) => invoke("mkt:reviews-feedback", req ?? {}),
    reviewsExternal: (req?: IpcContract["mkt:reviews-external"]["req"]) => invoke("mkt:reviews-external", req ?? {}),
    reviewsRecovery: (req?: IpcContract["mkt:reviews-recovery"]["req"]) => invoke("mkt:reviews-recovery", req ?? {}),
    couponsValidate: (req: IpcContract["mkt:coupons-validate"]["req"]) => invoke("mkt:coupons-validate", req),
    customers: (req?: IpcContract["mkt:customers"]["req"]) => invoke("mkt:customers", req ?? {}),
  },
  del: {
    assignments: (req?: IpcContract["del:assignments"]["req"]) => invoke("del:assignments", req ?? {}),
    executives: () => invoke("del:executives"),
    assign: (req: IpcContract["del:assign"]["req"]) => invoke("del:assign", req),
    updateStatus: (req: IpcContract["del:update-status"]["req"]) => invoke("del:update-status", req),
    proof: (req: IpcContract["del:proof"]["req"]) => invoke("del:proof", req),
    unavailable: (req: IpcContract["del:unavailable"]["req"]) => invoke("del:unavailable", req),
    codCollected: (req: IpcContract["del:cod-collected"]["req"]) => invoke("del:cod-collected", req),
    codSummary: (req?: IpcContract["del:cod-summary"]["req"]) => invoke("del:cod-summary", req ?? {}),
    handovers: (req?: IpcContract["del:handovers"]["req"]) => invoke("del:handovers", req ?? {}),
    handoverCreate: (req: IpcContract["del:handover-create"]["req"]) => invoke("del:handover-create", req),
    aggregatorDashboard: () => invoke("del:aggregator-dashboard"),
    aggregatorSheets: () => invoke("del:aggregator-sheets"),
  },
} as const;
