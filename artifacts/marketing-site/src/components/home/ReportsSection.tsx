    ...
    <section className="py-12 md:py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-12 gap-6 md:gap-12 items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-3 gap-2.5 md:gap-3">
            {REPORTS.map(({ icon: Icon, title }) => (
              <div key={title} className="aspect-square rounded-xl border border-border bg-card p-3 md:p-4 flex flex-col items-center justify-center text-center hover:border-primary/40 transition-colors">
                <div className="p-2 md:p-2.5 rounded-lg bg-primary/10 mb-2 md:mb-3">
