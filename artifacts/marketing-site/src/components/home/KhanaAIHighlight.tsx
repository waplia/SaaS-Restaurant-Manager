...
export function KhanaAIHighlight() {
  return (
    <section className="relative py-28 overflow-hidden bg-[#0b0b10] text-white">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        <div className="max-w-3xl mx-auto text-center mb-14">
          <div className="inline-flex items-center rounded-full border border-white/15 bg-white/5 backdrop-blur px-3 py-1 text-xs font-medium text-white/80 mb-5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
          {AI_FEATURES.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="p-6 rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur hover:bg-white/[0.07] transition-colors">
              <div className="mb-4 inline-flex p-2.5 rounded-lg bg-gradient-to-br from-primary/30 to-pink-500/20 border border-white/10">
        ...
        <div className="text-center">
          <Link href="/features">
            <Button size="lg" className="text-base h-12 px-7 bg-primary hover:bg-primary/90 text-primary-foreground">
