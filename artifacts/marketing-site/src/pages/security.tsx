        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>We respect your privacy and that of your customers. TableTrack is fully compliant with GDPR and CCPA regulations, providing you with the tools to handle data requests effortlessly.</p>
