...
export default function Integrations() {
  useSeo({
    title: "Integrations",
    description: "TableTrack integrates with the tools you already use. Payments, delivery, accounting, and more.",
  });
      ...
      <main className="flex-grow pt-24 pb-32">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground">Connect TableTrack to your favorite tools for a seamless operational flow.</p>
          </div>
