    ...
    <SiteLayout>
      ...
      <section className="py-12 md:py-16 bg-muted/30 border-y border-border">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-bold tracking-tight mb-4">See it side by side, on your own menu.</h2>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">Book a free demo. We'll set up a sandbox with your menu and walk through the gaps you care about most.</p>
