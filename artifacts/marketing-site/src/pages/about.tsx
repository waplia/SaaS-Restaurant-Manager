...
export default function About() {
  useSeo({
    title: "About Us",
    description: "The story behind TableTrack and our mission to empower restaurant owners.",
  });
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p>TableTrack was born out of frustration. Our founders grew up in the restaurant industry, watching brilliant chefs struggle with clunky, outdated software that crashed during the rush and provided terrible insights.</p>
