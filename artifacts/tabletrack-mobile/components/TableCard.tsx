...
const STATUS_PALETTE: Record<string, { bg: string; text: string; border: string; dot: string }> = {
  ...
  // Task #637 — derived statuses for the floor map so a waiter can tell at
  // a glance which tables have new orders waiting, food cooking, or food
  // ready to run.
  ordered: { bg: "#fff7ed", text: "#9a3412", border: "#fed7aa", dot: "#fb923c" },
  preparing: { bg: "#fffbeb", text: "#92400e", border: "#fde68a", dot: "#f59e0b" },
  ready: { bg: "#ecfeff", text: "#0e7490", border: "#a5f3fc", dot: "#06b6d4" },
  bill_requested: { bg: "#f3e8ff", text: "#6d28d9", border: "#ddd6fe", dot: "#7c3aed" },
  billed: { bg: "#f3e8ff", text: "#6d28d9", border: "#ddd6fe", dot: "#7c3aed" },
  paid: { bg: "#ecfdf5", text: "#047857", border: "#a7f3d0", dot: "#10b981" },
