...
export const PLAN_BOOLEAN_FEATURES: PlanBooleanFeature[] = [
  ...
  { key: "loyalty_network",       label: "Loyalty Network (cross-restaurant)", description: "Join the cross-restaurant loyalty network so customers can earn and redeem across participating outlets via the customer wallet app.", category: "growth", defaultValue: false, defaultPlans: ["pro","enterprise"], sidebarHref: "/customers/loyalty-network" },
  ...
  { key: "customer_app",          label: "White-label Customer App",    description: "Publish a branded customer ordering & loyalty app with your logo, colors, hero banner, gallery, reviews and app-exclusive coupons.", category: "platform", defaultValue: false, defaultPlans: ["pro","enterprise"], sidebarHref: "/settings/customer-app" },
  ...
  { key: "dedicated_implementation", label: "Dedicated implementation",  description: "Assigned onboarding manager runs a structured go-live checklist with SLA timers and post-launch follow-ups.", category: "platform", defaultValue: false, defaultPlans: ["enterprise"], sidebarHref: "/setup/onboarding" },
  ...
  { key: "accounting_back_office", label: "Accounting Back Office",     description: "Chart of accounts, journals, AP/AR ledgers, vendor bills, period close and financial statements.", category: "growth", defaultValue: false, defaultPlans: ["pro","enterprise"], sidebarHref: "/finance/accounting-books" },
  { key: "capital_financing",     label: "Capital & Financing",         description: "Sales-based advances and term-loan offers from partner lenders with eligibility, applications, document upload and daily repayment ledger.", category: "growth", defaultValue: false, defaultPlans: ["enterprise"], sidebarHref: "/capital" },
  { key: "offline_pos",           label: "Offline-first POS",           description: "POS keeps accepting orders, KOTs and payments when internet drops; changes queue locally and sync on reconnect.", category: "operations", defaultValue: false, defaultPlans: ["growth","pro","enterprise"], sidebarHref: "/pos-sync" },
  ...
  { key: "ops_order_capacity",       label: "Order Throttling & Kitchen Capacity", description: "Cap orders per slot/item/outlet/order-type, one-tap pause online & per-zone, auto-extend prep time during rush with manager alerts, and customer-facing 'next available' messaging.", category: "kitchen_quality", defaultValue: false, defaultPlans: ["growth","pro","enterprise"], sidebarHref: "/settings/order-capacity" },
